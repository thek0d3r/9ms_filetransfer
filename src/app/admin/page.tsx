...
export default async function AdminPage() {
  ...
  return (
    <main className="admin-shell">
      <header className="admin-head"><div><p className="eyebrow"><span>07</span> Operator telemetry</p><h1>CONTROL<br /><em>ROOM.</em></h1></div><p>Account and product activity.<br />No file contents. No raw IP addresses.</p></header>
